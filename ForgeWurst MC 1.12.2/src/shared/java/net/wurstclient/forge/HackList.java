...
import net.wurstclient.forge.hacks.games.BedWars;
import net.wurstclient.forge.hacks.games.SkywarsCamper;
import net.wurstclient.forge.hacks.movement.*;
import net.wurstclient.forge.hacks.pathing.HighwayBuilder;
...
public final class HackList extends WHackList
{
	...
	public final TestGame testGame = register(new TestGame());
