...
public final class AntiSpamHack extends Hack
{
	...
	public static List<String> convertToStrings(List<String> numbers) {
		...
		for (String number : numbers) {
			...
			for (int i = 0; i < number.length(); i++) {
				...
				char convertedChar = (char) ('a' + digit - 1);
				convertedNumber.append(convertedChar);
			}
			result.add(convertedNumber.toString());
		}
