...
public class InvUtil extends Hack {

    public InvUtil(String name, String description) {
     ...
     */
    public static void switchItem(int slot, boolean sleep) throws InterruptedException {
        ...
        if (slot < 9) {
            ...
            clickSlot(slot);
            if (sleep) TimerUtils.sleep(200);
            clickSlot(freeSlot);
            if (sleep) TimerUtils.sleep(200);
            clickSlot(slot);
            if (sleep) TimerUtils.sleep(200);
            mc.player.inventory.currentItem = freeSlot;
            if (sleep) TimerUtils.sleep(100);
        }
