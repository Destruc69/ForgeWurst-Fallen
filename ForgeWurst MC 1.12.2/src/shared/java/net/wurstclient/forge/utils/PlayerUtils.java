...
public class PlayerUtils
{
	...
	public static boolean CanSeeBlockEntity(Entity entity, BlockPos p_Pos)
	{
		if (mc.player == null)
			return false;

		return mc.world.rayTraceBlocks(new Vec3d(entity.lastTickPosX, entity.lastTickPosY + (double)mc.player.getEyeHeight(), entity.lastTickPosZ), new Vec3d(p_Pos.getX(), p_Pos.getY(), p_Pos.getZ()), false, true, false) == null;
	}
