...
public class PathfinderAStarAIR {
    ...
    public PathfinderAStarAIR(BlockPos startBlockPos, BlockPos endBlockPos) {
    ...
    private boolean checkPositionValidity(BlockPos loc, boolean checkGround) {
        return checkPositionValidity(loc.getX(), loc.getY(), loc.getZ(), checkGround);
    }

    private boolean checkPositionValidity(double x, double y, double z, boolean checkGround) {
